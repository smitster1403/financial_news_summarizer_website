...
export default function DisclaimerModal({ onAccept, authorName = "the developer" }: DisclaimerModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-xl p-6 mx-4 transform transition-all">
        ...
        <div className="my-6 text-gray-700 dark:text-gray-300 space-y-4">
